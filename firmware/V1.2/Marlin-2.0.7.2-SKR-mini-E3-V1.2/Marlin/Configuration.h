...
#define ENDSTOP_INTERRUPTS_FEATURE  // BLT CEH
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  //CEH BLT
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.5, -10, 0 }   // CL CEH
...
#define XY_PROBE_SPEED (100*60) // bl ceh was 133x60
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // BLT CEH
...
#define AUTO_BED_LEVELING_BILINEAR  // BLT CEH
